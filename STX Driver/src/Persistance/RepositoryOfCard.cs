...
{
    class RepositoryOfCard : IDataBase, IRepositoryOfCard
    {
        string query = null;
        CardFlota card = null;
        ...
        public CardFlota Execute()
        {
            ...
            {
                Console.WriteLine("CardFlota Execute: {0}", ex.Message); 
            }
            return card;
        }
